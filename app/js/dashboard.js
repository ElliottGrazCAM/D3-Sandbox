...
function renderEvent(eventType) {
    ...
    if (sortedRev.length > 0 || sortedExp.length > 0) {
        const marginNet = { top: 30, right: 30, bottom: 30, left: 60 }, widthNet = 800 - marginNet.left - marginNet.right, heightNet = 250 - marginNet.top - marginNet.bottom;
    ...
    if (combinedData.length > 0) {
        const marginAcc = { top: 20, right: 30, bottom: 40, left: 120 }, widthAcc = 800 - marginAcc.left - marginAcc.right, heightAcc = (combinedData.length * 40) || 100;
